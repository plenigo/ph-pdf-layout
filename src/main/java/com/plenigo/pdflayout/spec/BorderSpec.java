...
public class BorderSpec implements Serializable {
    ...
    private final com.plenigo.pdflayout.spec.BorderStyleSpec m_aTop;
    private final com.plenigo.pdflayout.spec.BorderStyleSpec m_aRight;
    private final com.plenigo.pdflayout.spec.BorderStyleSpec m_aBottom;
    private final com.plenigo.pdflayout.spec.BorderStyleSpec m_aLeft;

    /**
     * Constructor.
     *
     * @param aBorder The border to set for all sides (left, top, right, bottom). Maybe
     *                <code>null</code>.
     */
     ...
     * Constructor.
     *
     * @param aBorderY The border to set for top and bottom. Maybe <code>null</code>.
     * @param aBorderX The border to set for left and right. Maybe <code>null</code>.
     */
     ...
     * Constructor.
     *
     * @param aBorderTop    The border to set for top. Maybe <code>null</code>.
     * @param aBorderRight  The border to set for right. Maybe <code>null</code>.
     * @param aBorderBottom The border to set for bottom. Maybe <code>null</code>.
     * @param aBorderLeft   The border to set for left. Maybe <code>null</code>.
     */
    ...
    public final float getTopWidth() {
        final com.plenigo.pdflayout.spec.BorderStyleSpec aBSS = m_aTop;
    ...
    public final float getRightWidth() {
        final com.plenigo.pdflayout.spec.BorderStyleSpec aBSS = m_aRight;
        return aBSS == null ? 0 : aBSS.getLineWidth();
    }
    ...
    public final float getBottomWidth() {
        final com.plenigo.pdflayout.spec.BorderStyleSpec aBSS = m_aBottom;
        return aBSS == null ? 0 : aBSS.getLineWidth();
    }
    ...
    public final float getLeftWidth() {
        final com.plenigo.pdflayout.spec.BorderStyleSpec aBSS = m_aLeft;
        return aBSS == null ? 0 : aBSS.getLineWidth();
    }
