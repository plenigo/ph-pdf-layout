...
import static com.plenigo.pdflayout.render.PLRenderHelper.fillAndRenderBorderRounded;
...
public abstract class AbstractPLText<IMPLTYPE extends AbstractPLText<IMPLTYPE>> extends
     ...
     *
     * @param aFontSpec The new font spec. Must not be <code>null</code>.
     *
     ...
     *
     * @param bReplacePlaceholder <code>true</code> if placeholders should be replaced, <code>false</code> otherwise.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param fBorderRadius The actual border radius. Only values &gt; 0 will draw a radius.
     *
     * @return this for chaining
     *
     * @since v7.4.1
    ...
    protected void onRender(@NonNull final PageRenderContext aCtx) throws IOException {
        ...
        for (final TextAndWidthSpec aTW : m_aPreparedLines) {
            ...
            } else if ((bDoTextJustify && !bBeforeLastLine) || (bDoTextBlock && aTW.isDisplayAsNewline())) {
