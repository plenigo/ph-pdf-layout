...
public interface IPLCellRange {
     ...
     *
     * @param nRowIndex    The row, 0-based.
     * @param nColumnIndex The column, 0-based.
     *
     ...
     *
     * @param nRowIndex the row to check
     *
     ...
     *
     * @param nColumnIndex the column to check
     *
     ...
     *
     * @param aOther a candidate cell range address to check for intersection with this
