...
public interface IPLTableCellFilter {
     ...
     *
     * @param aCell                    the current table cell. Never <code>null</code>.
     * @param nCellIndex               The cell index. Always &ge; 0.
     * @param nEffectiveCellStartIndex The effective start cell index including colspan. Always &ge; 0.
     * @param nEffectiveCellEndIndex   The effective cell end index including colspan (= effective cell
