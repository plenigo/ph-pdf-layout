...
public abstract class AbstractPLExternalLink<IMPLTYPE extends AbstractPLExternalLink<IMPLTYPE>> extends
     ...
     *
     * @param eLinkBorderStyle The border style to use. May be <code>null</code>.
     *
     * @return this for chaining.
     *
     * @since v7.4.1
     ...
     *
     * @param aLinkDashPattern The link dash pattern to use. May be <code>null</code>.
     *
     * @return this for chaining.
     *
     * @since v7.4.1
     ...
     *
     * @param fLinkBorderWidth The link border width to use. May be <code>null</code>.
     *
     * @return this for chaining.
     *
     * @since v7.4.1
     ...
     *
     * @param aLinkColor The link color to use. May be <code>null</code>.
     *
     * @return this for chaining.
     *
     * @since v7.4.1
