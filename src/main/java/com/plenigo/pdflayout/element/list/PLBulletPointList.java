...
public class PLBulletPointList extends AbstractPLRenderableObject<PLBulletPointList> implements
     ...
     * Constructor
     *
     * @param aWidthSpec          The width of the left side that contains the "bullet". The rest is used for the content.
     *                            May not be <code>null</code>.
     * @param aBulletPointCreator The callback to create the actual bullet point which might be any PL* object.
     */
