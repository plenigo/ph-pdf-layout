...
public final class PLRenderHelper {
     ...
     *
     * @param aElement       The element currently rendered. May not be <code>null</code>.
     * @param aContentStream Content stream
     * @param fLeft          Left position (including left border width)
     * @param fTop           Top position (including top border width)
     * @param fWidth         Width (excluding left and right border width)
     * @param fHeight        Height (excluding top and bottom border width)
     * @param aBorder        Border to use. May not be <code>null</code>.
     *
     ...
     * an element.
     *
     * @param aElement The element to be rendered. May not be <code>null</code>.
     * @param aCtx     The render context incl. the content stream.
     * @param fIndentX Additional x-indentation
     * @param fIndentY Additional y-indentation
     ...
     * @param aContentStream Content stream to act on. May not be <code>null</code>.
     * @param <T>            Type that implements {@link IPLHasFillColor} and {@link IPLHasMarginBorderPadding}
     *
     * @throws IOException in case writing fails
     */
