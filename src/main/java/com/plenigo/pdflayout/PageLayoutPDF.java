...
public class PageLayoutPDF implements IPLVisitable {
    ...
    private com.plenigo.pdflayout.IPDDocumentCustomizer m_aDocumentCustomizer;
    ...
    /**
     * @param bCompressPDF <code>true</code> to enable creation of compressed PDFs, <code>false</code> to disable
     *                     it.
     *
    ...
    /**
     * @param bCreatePDF_A <code>true</code> to enable creation of PDF/A, <code>false</code> to disable it.
     *
     * @return this for chaining
     *
     * @since 6.0.3
    ...
    /**
     * @return the pdf version to use.
     */
    public final float getPdfVersion() {
        return m_fPdfVersion;
    }

    /**
     * @param fPdfVersion pdf version to use
     */
    @NonNull
    public final PageLayoutPDF setPdfVersion(final float fPdfVersion) {
        m_fPdfVersion = fPdfVersion;
        return this;
    }
     ...
     *
     * @param sDocumentAuthor The author to set. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     */
    @Nullable
    public final ZonedDateTime getDocumentCreationDateTime() {
        return m_aDocumentCreationDate == null ? null : m_aDocumentCreationDate;
    }
    ...
    /**
     * @param aDocumentCreationDate The document creation date to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param sDocumentCreator The document creator. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param sDocumentTitle The document title to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param sDocumentKeywords The document keywords to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param sDocumentSubject The document subject to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param sDocumentLanguage The document language to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param aPageSet The page set to remove. May be <code>null</code>.
     *
     ...
     * are prepended to the final PDF. The default is 0.
     *
     * @param nCustomLeadingPageCount The custom leading page count. Only values &ge; 0 are considered.
     *
     * @return this for chaining
     *
     ...
     * are appended to the final PDF. The default is 0.
     *
     * @param nCustomTrailingPageCount The custom trailing page count. Only values &ge; 0 are considered.
     *
     * @return this for chaining
     *
     * @see #setCustomTrailingPageCount(int)
     ...
     *
     * @param nCustomTotalPageCount The custom total page count. Only values &gt; 0 are considered.
     *
     * @return this for chaining
     *
     * @since 7.4.2
     ...
     *
     * @param aDocumentCustomizer The customizer to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
    public final PageLayoutPDF setDocumentCustomizer(@NonNull final IPDDocumentCustomizer aDocumentCustomizer) {
     ...
     *
     * @param aMetadataCustomizer The customizer to use. May be <code>null</code>.
     *
     * @return this for chaining
     */
    @NonNull
     ...
     *
     * @param aOS The output stream to write to. May not be <code>null</code>. Is closed automatically
     ...
     * @return this for chaining
     *
     * @throws com.plenigo.pdflayout.PDFCreationException In case of an error
     */
    @NonNull
    public PageLayoutPDF renderTo(@NonNull @WillClose final OutputStream aOS) throws com.plenigo.pdflayout.PDFCreationException {
        ...
        try (final NonBlockingByteArrayOutputStream aTmpOS = new NonBlockingByteArrayOutputStream()) {
            ...
            try (final PDDocument aDoc = new PDDocument();
                ...
                // Set document properties
                {
                    ...
                    aProperties.setProducer(com.plenigo.pdflayout.PLConfig.PROJECT_NAME +
                            " " +
                            com.plenigo.pdflayout.PLConfig.PROJECT_VERSION +
                            " - " +
                            com.plenigo.pdflayout.PLConfig.PROJECT_URL);
            ...
            if (m_bCreatePDF_A) {
                ...
                try (final PDDocument aDoc = Loader.loadPDF(aTmpOS.getBufferOrCopy());
                    ...
                    throw new com.plenigo.pdflayout.PDFCreationException("IO Error", ex);
                } catch (final Exception ex) {
                    throw new com.plenigo.pdflayout.PDFCreationException("Internal error", ex);
                }
            }
        } // close aTmpOS
     ...
     * Render this layout to an OutputStream.
     *
     * @param aCustomizer The customizer to be invoked before the document is written to the stream. May be
     *                    <code>null</code>.
     * @param aOS         The output stream to write to. May not be <code>null</code>. Is closed automatically.
     *
     * @return this for chaining
     *
     * @throws com.plenigo.pdflayout.PDFCreationException In case of an error
     * @deprecated Since 5.1.0; Call {@link #setDocumentCustomizer(com.plenigo.pdflayout.IPDDocumentCustomizer)} and than
     * {@link #renderTo(OutputStream)}
     */
    @NonNull
    @Deprecated
    public final PageLayoutPDF renderTo(@Nullable final IPDDocumentCustomizer aCustomizer,
                                        @NonNull @WillClose final OutputStream aOS) throws com.plenigo.pdflayout.PDFCreationException {
     ...
     *
     * @param aFile The output stream to write to. May not be <code>null</code>. Is closed automatically.
     *
     * @return this for chaining
     *
     * @throws com.plenigo.pdflayout.PDFCreationException In case of an error
