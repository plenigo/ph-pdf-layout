...
public interface IPLHasPadding<IMPLTYPE extends IPLHasPadding<IMPLTYPE>> extends
     ...
     *
     * @param fPadding The value to use.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fPaddingY The Y-value to use (for top and bottom).
     * @param fPaddingX The X-value to use (for left and right).
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fPaddingTop    Top
     * @param fPaddingRight  Right
     * @param fPaddingBottom Bottom
     * @param fPaddingLeft   Left
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param aPadding Padding to use. May not be <code>null</code>.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fPadding The value to add.
     *
     * @return this
     */
    @NonNull
