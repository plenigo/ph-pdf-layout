...
public final class PLPageSetPrepareResult {
    ...
    /**
     * @param nPageIndex 0-based page index
     *
     ...
     *
     * @param fHeaderHeight Height without margin, border and padding.
     */
     ...
     * called once.
     *
     * @param fFooterHeight Height without padding or margin.
     */
    ...
    /**
     * @param aElement The element to be added. May not be <code>null</code>. The element
     ...
     * page.
     *
     * @param aCurPageElements The list to use. May neither be <code>null</code> nor empty.
     */
