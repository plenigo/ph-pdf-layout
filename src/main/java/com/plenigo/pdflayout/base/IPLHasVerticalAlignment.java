...
public interface IPLHasVerticalAlignment<IMPLTYPE extends IPLHasVerticalAlignment<IMPLTYPE>> extends IPLRenderableObject<IMPLTYPE> {
     ...
     *
     * @param eVertAlign The new vertical alignment. May not be <code>null</code>.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fAvailableHeight The available height of the surrounding element.
     *
     ...
     *
     * @param fAvailableHeight The available height of the surrounding element. This is usually
     *                         larger than fElementHeight.
     * @param fElementHeight   The height of the element to align.
     *
     * @return The indentation offset. Always &ge; 0.
     */
    @Nonnegative
