...
public abstract class AbstractPLRenderableObject<IMPLTYPE extends AbstractPLRenderableObject<IMPLTYPE>> extends
     ...
     *
     * @throws IllegalStateException if not yet prepared
     */
     ...
     *
     * @param aCtx Preparation context. Never <code>null</code>.
     *
     ...
     * get the render size.
     *
     * @param aPreparedSize The originally prepared size.
     *
     ...
     * size
     *
     * @param aPreparedSize Prepared size without padding and margin.
     */
    private void _setPreparedSize(@NonNull final SizeSpec aPreparedSize) {
        ...
        if (PLDebugLog.isDebugPrepare()) {
            String sSuffix = "";
            if (this instanceof com.plenigo.pdflayout.base.IPLHasMarginBorderPadding<?>) {
                sSuffix = " with " +
                        PLDebugLog.getXMBP((com.plenigo.pdflayout.base.IPLHasMarginBorderPadding<?>) this) +
                        " and " +
                        PLDebugLog.getYMBP((com.plenigo.pdflayout.base.IPLHasMarginBorderPadding<?>) this);
            }
     ...
     *
     * @param aPreparedSize The new prepared size without margin, border and padding.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param aCtx Rendering context. Never <code>null</code>.
     *
