...
public interface IPLHasMargin<IMPLTYPE extends IPLHasMargin<IMPLTYPE>> extends
     ...
     *
     * @param fMargin The value to use.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fMarginY The Y-value to use (for top and bottom).
     * @param fMarginX The X-value to use (for left and right).
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fMarginTop    Top
     * @param fMarginRight  Right
     * @param fMarginBottom Bottom
     * @param fMarginLeft   Left
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param aMargin Margin to use. May not be <code>null</code>.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fMargin The value to add.
     *
     * @return this
     */
    @NonNull
