...
public interface IPLElement<IMPLTYPE extends IPLElement<IMPLTYPE>> extends
     ...
     *
     * @param fMinWidth  Minimum width. Must be &ge; 0.
     * @param fMinHeight Minimum height. Must be &ge; 0.
     *
     * @return this
     */
    @NonNull
     ...
     * Set the minimum size to be used. Excluding outline.
     *
     * @param aMinSize Minimum size. May not be <code>null</code>.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fMaxWidth  Maximum width. Must be &ge; 0.
     * @param fMaxHeight Maximum height. Must be &ge; 0.
     *
     * @return this
     */
    @NonNull
     ...
     * Set the maximum size to be used. Excluding outline.
     *
     * @param aMaxSize Maximum size. May not be <code>null</code>. Must both be &ge; 0.
     *
     * @return this
     */
    @NonNull
     ...
     *
     * @param fWidth  Width to use. Must be &ge; 0.
     * @param fHeight Height to use. Must be &ge; 0.
     *
     * @return this
     *
